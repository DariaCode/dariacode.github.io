...
let spells = [
    'Aberto: <br> unlocks a door; first seen in Fantastic Beasts (the movie)',
    'Accio: <br> Summoning Charm; used to summon objects toward the caster (usually from a long distance)',
    'Aguamenti: produces a jet of water from the caster’s wand',
   'Alohomora:<br> used to unlock and open doors',
  'Avada Kedavra:<br> the Killing Curse; causes a green flash of light; Harry Potter is the only known survivor of this curse; one of three Unforgivable Curses banned by the Ministry of Magic',
  ...
  'Confringo:<br> Blasting Charm; causes items the charm comes in contact with to burst into flames',
  'Confundo:<br> Confundus Charm; causes the victim to become confused and disoriented',
  'Crucio:<br> causes the victim extreme pain; one of three Unforgivable Curses banned by the Ministry of Magic',
  'Descendo:<br> causes the target object to move downward',
  'Diffindo:<br> Severing Charm; causes the targeted object to rip or tear',
  'Disillusionment Charm:<br> hides objects and humans',
  'Engorgio:<br> Engorgement Charm; causes objects to increase in size',
  ...
  'Impedimenta:<br> Impediment Jinx; prevents the victim from approaching the caster (by knocking back, tripping, etc.)',
  'Imperio:<br> removes the victim’s free will and ability to make decisions for him- or herself; one of three Unforgivable Curses banned by the Ministry of Magic',
  ...
  'Petrificus Totalus:<br> Full Body-Bind Curse; temporarily binds the victim’s entire body, thus immobilizing him or her',
  'Portus:<br> turns objects into Portkeys',
  'Priori Incantato:<br> creates an “echo” of previously performed spells',
  'Protego:<br> Shield Charm; rebounds minor to moderate hexes, jinxes, and spells upon their caster',
  'Reducto:<br> Reductor Curse; breaks objects and in its strongest form has the ability to disintegrate them',
  ...
  'Revelio:<br> a revealing spell; first used in the Fantastic Beasts film to reveal Graves is Grindelwald',
  ...
  'Wingardium Leviosa:<br> Hover Charm; causes an object to levitate'
  ];
